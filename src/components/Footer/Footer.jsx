    ...
    <section className="footer">
        <div className="box-container">
            ...
            <div className="box">
                ...
                <a href="#"> <i className="fas fa-envelope"></i> careconnect.com</a>
                <a href="#"> <i className="fas fa-envelope"></i> careconnect@gmail.com</a>
                <a href="#"> <i className="fas fa-map-marker-alt"></i> XXX - #####</a>
            </div>
            <div className="box">
                <h3>follow us</h3>
        ...
        <div className="credit">created by <span>CareConnect</span> | all right reserved</div>
    </section>
  )
}
